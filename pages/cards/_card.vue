<template>
  <div v-if="dataLoaded">
    ...
    <confirmed-cases-attributes-card
      ...
      :graph-data="Data"
    />
    <confirmed-cases-attributes-card-city
      v-else-if="
        this.$route.params.card == 'attributes-of-confirmed-cases-city'
      "
      :graph-data="Data"
    />
    <confirmed-cases-attributes-card-map-f
      v-else-if="
        this.$route.params.card == 'attributes-of-confirmed-cases-mapf'
      "
      :graph-data="Data"
    />
    <not-public-card
      v-else-if="this.$route.params.card == 'not-public-card'"
      :graph-data="Data"
    />
    <tested-number-card
...
export default {
  ...
  data() {
    ...
    switch (this.$route.params.card) {
      ...
      case 'attributes-of-confirmed-cases-city':
      case 'attributes-of-confirmed-cases-mapf':
      case 'not-public-card':
